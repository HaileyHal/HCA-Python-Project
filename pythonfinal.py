# i think this is an extra file, don't delete but I don't think this is the main one
...
for origin in departure_airports: # looping through each origin/departure airport 
    ...
    try: # what I want to happen
        ...
        # pass #just skip to the next departure airport. most of the errors are caused bc there is no flight from that airport
